...
精神と時の部屋のような一年、もとい、成長なんてゼロだったので、
無為が無限ループしていた一年も終わるので、見送っていたMac環境のリフレッシュを実施しました。
...
当初はGoogle Chrome + [Side Space](https://www.sidespace.app)拡張機能でほぼArcと同等のことができるかと試していました。しかし、Arcの全機能を再現しようとすると拡張の組み合わせが増えるばかりで、本末転倒だと気づきました。
...
どれも「やろうと思えばすぐできたこと」ばかりですが、無為とは言えループの中で私物MacBookを使っていたのであまり大きく環境を変えずに維持してきました。
