+++
title = "上司に説明できる生成AIガイドライン - NIST AI RMF準拠Check List"
description = """
NIST AI RMF準拠の生成AIガバナンスチェックリストを公開しました。
ChatGPT・Claude・Gemini等のSaaS型生成AIを業務利用する際の
ガイドライン策定に使える、全7章・120項目の実践的な内容です。
非専門家でも使いやすく、小規模な組織でも今すぐ始められます。
"""
date = 2026-01-29
...
現在v1.0.0-rc.1（リリース候補版）です。フィードバックを募集しています。
