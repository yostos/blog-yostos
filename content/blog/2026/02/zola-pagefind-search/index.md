...
ソリューション検討で、静的サイトで使える検索エンジンをいくつか比較検討しました。
次のようなものを検討しましたが、下表のような理由で見送ってりました。
