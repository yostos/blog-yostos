...
description = """
1986年、8ビットパソコンSharp X1で画像をASCII文字に自動変換し、
パソコン通信のBBSに投稿していました。当時のアルゴリズムを
GoでCLIツール img2char として再実装した経緯と技術を紹介します。
"""
date = 2026-02-21
...
canonical_url = "https://zenn.dev/yostos/articles/img2char-ascii-art-1986"
+++
...
この記事は
[Zenn.dev](https://zenn.dev/yostos/articles/img2char-ascii-art-1986)
に掲載した記事の転載です。
{% end %}
