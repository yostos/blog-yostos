---
description: Generate a cover image for an article using OpenAI gpt-image-1 API. Read article content, craft a prompt, generate 1536x1024 image, and convert to cover.webp.
---

# Article Cover Image Generation

Generate a cover image (cover.webp) for an article using OpenAI gpt-image-1 API.
...
- Craft a gpt-image-1 prompt that captures the article's essence
